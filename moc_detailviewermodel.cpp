...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DetailViewerModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DetailViewerModel_t qt_meta_stringdata_DetailViewerModel = {
    {
QT_MOC_LITERAL(0, 0, 17), // "DetailViewerModel"
QT_MOC_LITERAL(1, 18, 13), // "clicked_event"
...
QT_INIT_METAOBJECT const QMetaObject DetailViewerModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractItemModel::staticMetaObject>(),
    qt_meta_stringdata_DetailViewerModel.data,
